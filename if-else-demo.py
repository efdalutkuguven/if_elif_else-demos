...
#    durumunu kontrol ediniz. Ehliyet alabilme durumu yaş en az 18
...
#     print(f"ortalmanız: {ortalama} notunuz: 1")
# elif (ortalama >= 45) and (ortalama < 55):
#     print(f"ortalmanız: {ortalama} notunuz: 2")
# elif (ortalama >= 55) and (ortalama < 70):
#     print(f"ortalmanız: {ortalama} notunuz: 3")
# elif (ortalama >= 70) and (ortalama < 85):
#     print(f"ortalmanız: {ortalama} notunuz: 4")
# elif (ortalama >= 85) and (ortalama <= 100):
#     print(f"ortalmanız: {ortalama} notunuz: 5")
# else:
...
#    2. Bakım => 2. Yıl
#    3. Bakım => 3. Yıl
#    ** Süre hasabını alınan gün, ay, yıl bilgisine göre gün bazlı hesaplayınız
#    *** datetime modülünü kullanmanız gerekiyor
import datetime

tarih = input(" aracınız hangi tarihte trafiğe çıktı(0219/8/9): ")
tarih = tarih.split("/")
#print(tarih[0])
#print(tarih[1])
#print(tarih[2])
